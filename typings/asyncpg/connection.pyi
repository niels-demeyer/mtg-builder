...
class Connection(metaclass=ConnectionMeta):
    ...
    async def execute(self, query: str, *args, timeout: typing.Optional[float] = ...) -> str:
    ...
    async def executemany(self, command: str, args, *, timeout: typing.Optional[float] = ...):
    ...
    async def fetchmany(self, query, args, *, timeout: typing.Optional[float] = ..., record_class=...):
...
async def connect(dsn=..., *, host=..., port=..., user=..., password=..., passfile=..., service=..., servicefile=..., database=..., loop=..., timeout=..., statement_cache_size=..., max_cached_statement_lifetime=..., max_cacheable_statement_size=..., command_timeout=..., ssl=..., direct_tls=..., connection_class=..., record_class=..., server_settings=..., target_session_attrs=..., krbsrvname=..., gsslib=...):
