...
class PoolConnectionProxyMeta(type):
    def __new__(mcls, name: str, bases: tuple[Type[Any], ...], dct: dict[str, Any], *, wrap: bool = ...) -> PoolConnectionProxyMeta:
        ...
...
class PoolConnectionHolder:
    __slots__ = ...
    def __init__(self, pool: Pool, *, max_queries: float, setup: Optional[Callable[[PoolConnectionProxy], Awaitable[None]]], max_inactive_time: float) -> None:
        ...
...
class Pool:
    ...
    async def execute(self, query: str, *args, timeout: Optional[float] = ...) -> str:
    ...
    async def executemany(self, command: str, args, *, timeout: Optional[float] = ...): # -> Any:
    ...
    async def fetchval(self, query, *args, column=..., timeout=...): # -> Any:
    ...
    async def fetchrow(self, query, *args, timeout=..., record_class=...): # -> Any:
    ...
    async def fetchmany(self, query, args, *, timeout=..., record_class=...): # -> Any:
    ...
    async def copy_from_table(self, table_name, *, output, columns=..., schema_name=..., timeout=..., format=..., oids=..., delimiter=..., null=..., header=..., quote=..., escape=..., force_quote=..., encoding=...): # -> Any:
    ...
    async def copy_from_query(self, query, *args, output, timeout=..., format=..., oids=..., delimiter=..., null=..., header=..., quote=..., escape=..., force_quote=..., encoding=...): # -> Any:
    ...
    async def copy_to_table(self, table_name, *, source, columns=..., schema_name=..., timeout=..., format=..., oids=..., freeze=..., delimiter=..., null=..., header=..., quote=..., escape=..., force_quote=..., force_not_null=..., force_null=..., encoding=..., where=...): # -> Any:
    ...
    async def copy_records_to_table(self, table_name, *, records, columns=..., schema_name=..., timeout=..., where=...): # -> Any:
...
class PoolAcquireContext:
    ...
    def __await__(self): # -> Generator[Any, None, PoolConnectionProxy | Any]:
        ...
