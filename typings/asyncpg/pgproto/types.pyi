...
class BitString:
    ...
    @classmethod
    def frombytes(cls, bytes_: builtins.bytes | None = ..., bitlength: int | None = ...) -> Self:
        ...
    ...
    @classmethod
    def from_int(cls, x: int, length: int, bitorder: _BitOrderType = ..., *, signed: bool = ...) -> Self:
...
class Point(typing.Tuple[float, float]):
    ...
    __slots__ = ...
    def __new__(cls, x: (typing.SupportsFloat | typing.SupportsIndex | str | builtins.bytes | builtins.bytearray), y: (typing.SupportsFloat | typing.SupportsIndex | str | builtins.bytes | builtins.bytearray)) -> Self:
        ...
...
class Box(typing.Tuple[Point, Point]):
    ...
    __slots__ = ...
    def __new__(cls, high: typing.Sequence[float], low: typing.Sequence[float]) -> Self:
        ...
...
class LineSegment(typing.Tuple[Point, Point]):
    ...
    __slots__ = ...
    def __new__(cls, p1: typing.Sequence[float], p2: typing.Sequence[float]) -> Self:
        ...
...
class Path:
    ...
    def __getitem__(self, i: int | slice) -> Point | typing.Tuple[Point, ...]:
        ...
