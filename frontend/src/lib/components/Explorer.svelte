...
<div class="explorer">
  <header class="explorer-header">
    <h1>Card Explorer</h1>
    <p>Search and browse Magic: The Gathering cards</p>
  </header>
  ...
  <div class="search-bar">
    ...
    />
    <button onclick={searchCards} disabled={isLoading}>
  ...
  {#if selectedCard}
    <div class="card-modal" onclick={() => selectedCard = null}>
      <div class="modal-content" onclick={(e) => e.stopPropagation()}>
        <button class="close-btn" onclick={() => selectedCard = null}>✕</button>
        <img src={getImageUrl(selectedCard)} alt={selectedCard.name} />
